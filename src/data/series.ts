...
export const seriesData: Series[] = [
  {
    ...
    rating: "4.8",
    episodeList: [
      { number: 1, title: "The Baby at Her Door", duration: "3:40", videoUrl: "/api/video?ep=1", isFree: true },
      { number: 2, title: "Secrets Unfold", duration: "3:08", videoUrl: "/api/video?ep=2", isFree: true },
      { number: 3, title: "Rising Tensions", duration: "4:00", videoUrl: "/api/video?ep=3", isFree: true },
      { number: 4, title: "A Mother's Instinct", duration: "6:29", videoUrl: "/api/video?ep=4", isFree: true },
      { number: 5, title: "The Truth Emerges", duration: "8:08", videoUrl: "/api/video?ep=5", isFree: true },
      { number: 6, title: "Betrayal", duration: "8:30", videoUrl: "/api/video?ep=6", isFree: false },
      { number: 7, title: "Breaking Point", duration: "8:05", videoUrl: "/api/video?ep=7", isFree: false },
      { number: 8, title: "Hidden Enemies", duration: "8:19", videoUrl: "/api/video?ep=8", isFree: false },
      { number: 9, title: "Confrontation", duration: "10:00", videoUrl: "/api/video?ep=9", isFree: false },
      { number: 10, title: "The Reckoning", duration: "10:05", videoUrl: "/api/video?ep=10", isFree: false },
      { number: 11, title: "No Turning Back", duration: "10:00", videoUrl: "/api/video?ep=11", isFree: false },
      { number: 12, title: "Revelations", duration: "9:31", videoUrl: "/api/video?ep=12", isFree: false },
